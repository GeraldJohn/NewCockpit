...
//! Deklaration class SimRadio
class SimRadio : public SimData{

public:
    SimRadio (const char *ident,
...
int SimRadio::_pageSet = 0;
bool SimRadio::_print = true;
bool SimRadio::_swaped = false;
...
const String SimRadio::radioH[9] = {
    "Com1:           ",
    "Com2:           ",
    "Nav1:           ",
    "Nav2:           ",
...
//! Definition class SimRadio
SimRadio::SimRadio(const char *ident,
                           const int &Mode,
                           const int &Digits,
                           const int &NKSt,
...
//! Deklaration class SimStbyRadio
class SimStbyRadio : public SimData{

public:
    SimStbyRadio(const char *ident,
...
int SimStbyRadio::_pageSet = 0;
bool SimStbyRadio::_print = false;
bool SimStbyRadio::_swap = false;
...
void SimRadio::_updateActive(){}

//! Definition Methode _update
void SimRadio::_update(bool updateOutput){
    if (_mode == _pageSet){
        /// Stdby _swap == true =>
        if (_print){
            _print = false;
        ...
        /// SimRadio._swaped == true => Frequenztausch aufrufen
        if (_swaped) {
            _swaped = false;
...
void SimRadio::Lcd_print(){
    ...
    Lcd0.setCursor (posRadio, 0);
    Lcd0.print(_radioD);
    blink::_blink = true;
}


//! Definition Methode SimStbyRadio::_updateActive
void SimStbyRadio::_updateActive(){}

//! Definition Methode _update
void SimStbyRadio::_update(bool updateOutput){
    ...
    if (_page == _pageSet){
        ...
        if (_swap) {
            ...
            SimData::swap_Date(_drInt_active, SimRadio::_drInt_active);
            /// inherente Frequenz erhält getauschten Wert
            _drInt = _drInt_active;
            SimRadio::_swaped = true;
            Lcd_print();
        }
...
//! Definition SimStbyRadio Lcd_print
void SimStbyRadio::Lcd_print(){
